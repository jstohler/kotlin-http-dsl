...
class OptionRequestBuilderImplTests : AbstractMockServer() {

    @Test
    fun `build OPTIONS with body Test`() {
        val request = RequestBuilderImpl.build {
            options("https://jstohler.com") {
                "{'some-json': 'body'}"
            }
        ...
        assertThat(request.httpVerb, equalTo(HttpVerb.OPTIONS))
    ...
    @Test
    fun `build OPTIONS with no body Test`() {
        val request = RequestBuilderImpl.build {
            options("https://jstohler.com")
        }
    ...
    @Test
    fun `build OPTIONS with header and no body Test`() {
        val request = RequestBuilderImpl.build {
            options("https://jstohler.com")
            header { "Authorization: Bearer some_token" }
        }
    ...
    @Test
    fun `build OPTIONS with multiple header blocks Test`() {
        val request = RequestBuilderImpl.build {
            options("https://jstohler.com") {
                "{'some-json': 'body'}"
            }
    ...
    @Test
    fun `build OPTIONS with headers collection blocks Test`() {
        val request = RequestBuilderImpl.build {
            options("https://jstohler.com") {
                "{'some-json': 'body'}"
            }
    ...
    @Test
    fun `build OPTIONS with no value Test`() {
        assertThrows<IllegalArgumentException> { RequestBuilderImpl.build {} }
    }

    @Test
    fun `build OPTIONS with an empty address and body Test`() {
        assertThrows<IllegalArgumentException> { RequestBuilderImpl.build { options("") { "something" } } }
    }

    @Test
    fun `request OPTIONS Test`() {
        ...
        val actual = RequestBuilderImpl.request {
            options("http://localhost:1111") { "some-input-body" }
        }
        ...
        assertThat(actual.request.method(), equalTo("OPTIONS"))
    ...
    @Test
    fun `request OPTIONS without body Test`() {
    ...
    @Test
    fun `request OPTIONS with body and header Test`() {
    ...
    @Test
    fun `request OPTIONS with Body and multiple header Test`() {
    ...
    @Test
    fun `request OPTIONS with Body and headers Test`() {
