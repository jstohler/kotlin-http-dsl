...
class PutRequestBuilderImplTests : AbstractMockServer() {

    @Test
    fun `build PUT with body Test`() {
        val request = RequestBuilderImpl.build {
            put("https://jstohler.com") {
                "{'some-json': 'body'}"
            }
        ...
        assertThat(request.httpVerb, equalTo(HttpVerb.PUT))
    ...
    @Test
    fun `build PUT with no body Test`() {
        val request = RequestBuilderImpl.build {
            put("https://jstohler.com")
        }
    ...
    @Test
    fun `build PUT with header and no body Test`() {
        val request = RequestBuilderImpl.build {
            put("https://jstohler.com")
            header { "Authorization: Bearer some_token" }
        }
    ...
    @Test
    fun `build PUT with multiple header blocks Test`() {
        val request = RequestBuilderImpl.build {
            put("https://jstohler.com") {
                "{'some-json': 'body'}"
            }
    ...
    @Test
    fun `build PUT with headers collection blocks Test`() {
        val request = RequestBuilderImpl.build {
            put("https://jstohler.com") {
                "{'some-json': 'body'}"
            }
    ...
    @Test
    fun `build PUT with no value Test`() {
        assertThrows<IllegalArgumentException> { RequestBuilderImpl.build {} }
    }

    @Test
    fun `build PUT with an empty address and body Test`() {
        assertThrows<IllegalArgumentException> { RequestBuilderImpl.build { put("") { "something" } } }
    }

    @Test
    fun `request PUT Test`() {
        ...
        val actual = RequestBuilderImpl.request {
            put("http://localhost:1111") { "some-input-body" }
        }
        ...
        assertThat(actual.request.method(), equalTo("PUT"))
    ...
    @Test
    fun `request PUT without body Test`() {
    ...
    @Test
    fun `request PUT with body and header Test`() {
    ...
    @Test
    fun `request PUT with Body and multiple header Test`() {
    ...
    @Test
    fun `request PUT with Body and headers Test`() {
