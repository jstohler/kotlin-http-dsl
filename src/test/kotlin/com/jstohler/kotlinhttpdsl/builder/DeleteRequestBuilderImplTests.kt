...
class DeleteRequestBuilderImplTests : AbstractMockServer() {

    @Test
    fun `build DELETE with body Test`() {
        val request = RequestBuilderImpl.build {
            delete("https://jstohler.com") {
                "{'some-json': 'body'}"
            }
        ...
        assertThat(request.httpVerb, equalTo(HttpVerb.DELETE))
    ...
    @Test
    fun `build DELETE with no body Test`() {
        val request = RequestBuilderImpl.build {
            delete("https://jstohler.com")
        }
    ...
    @Test
    fun `build DELETE with header and no body Test`() {
        val request = RequestBuilderImpl.build {
            delete("https://jstohler.com")
            header { "Authorization: Bearer some_token" }
        }
    ...
    @Test
    fun `build DELETE with multiple header blocks Test`() {
        val request = RequestBuilderImpl.build {
            delete("https://jstohler.com") {
                "{'some-json': 'body'}"
            }
    ...
    @Test
    fun `build DELETE with headers collection blocks Test`() {
        val request = RequestBuilderImpl.build {
            delete("https://jstohler.com") {
                "{'some-json': 'body'}"
            }
    ...
    @Test
    fun `build DELETE with no value Test`() {
        assertThrows<IllegalArgumentException> { RequestBuilderImpl.build {} }
    }

    @Test
    fun `build DELETE with an empty address and body Test`() {
        assertThrows<IllegalArgumentException> { RequestBuilderImpl.build { delete("") { "something" } } }
    }

    @Test
    fun `request DELETE Test`() {
        ...
        val actual = RequestBuilderImpl.request {
            delete("http://localhost:1111") { "some-input-body" }
        }
        ...
        assertThat(actual.request.method(), equalTo("DELETE"))
    ...
    @Test
    fun `request DELETE without body Test`() {
    ...
    @Test
    fun `request DELETE with body and header Test`() {
    ...
    @Test
    fun `request DELETE with Body and multiple header Test`() {
    ...
    @Test
    fun `request DELETE with Body and headers Test`() {
