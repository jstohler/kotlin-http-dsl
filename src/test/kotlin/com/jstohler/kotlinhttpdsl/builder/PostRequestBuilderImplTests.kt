...
class PostRequestBuilderImplTests : AbstractMockServer() {

    @Test
    fun `build POST with body Test`() {
        ...
        assertThat(request.httpVerb, equalTo(HttpVerb.POST))
    ...
    @Test
    fun `build POST with no body Test`() {
        val request = RequestBuilderImpl.build {
            post("https://jstohler.com")
        }
    ...
    @Test
    fun `build POST with header and no body Test`() {
        val request = RequestBuilderImpl.build {
            post("https://jstohler.com")
            header { "Authorization: Bearer some_token" }
        }
    ...
    @Test
    fun `build POST with multiple header blocks Test`() {
        val request = RequestBuilderImpl.build {
            post("https://jstohler.com") {
                "{'some-json': 'body'}"
            }
    ...
    @Test
    fun `build POST with headers collection blocks Test`() {
        val request = RequestBuilderImpl.build {
            post("https://jstohler.com") {
                "{'some-json': 'body'}"
            }
    ...
    @Test
    fun `build POST with no value Test`() {
        assertThrows<IllegalArgumentException> { RequestBuilderImpl.build {} }
    }

    @Test
    fun `build POST with an empty address and body Test`() {
        assertThrows<IllegalArgumentException> { RequestBuilderImpl.build { post("") { "something" } } }
    }

    @Test
    fun `request POST Test`() {
        ...
        val actual = RequestBuilderImpl.request {
            post("http://localhost:1111") { "some-input-body" }
        }
        ...
        assertThat(actual.request.method(), equalTo("POST"))
    ...
    @Test
    fun `request POST without body Test`() {
    ...
    @Test
    fun `request POST with body and header Test`() {
    ...
    @Test
    fun `request POST with Body and multiple header Test`() {
    ...
    @Test
    fun `request POST with Body and headers Test`() {
